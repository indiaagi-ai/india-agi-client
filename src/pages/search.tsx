...
export function SearchPage() {
  ...
  const handleShare = () => {
    ...
    const messagePrefix = "Check out this AI consensus from IndiaAGI.ai: ";
    const marketingFooter =
      "\n\nGenerated by IndiaAGI.ai - Get nuanced insights on Indian challenges through multiple AI perspectives including ChatGPT, Gemini, Claude, and Grok.";

    const fullMessage = messagePrefix + consensus + marketingFooter;
